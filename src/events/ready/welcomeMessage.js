...
module.exports = (client) => {
    try {
        ...
        const statement1 = new ButtonBuilder()
            .setCustomId(process.env.EASY_CHANNEL_ID)
            .setLabel("LEGENDS")
            .setStyle(ButtonStyle.Secondary);

        const statement2 = new ButtonBuilder()
            .setCustomId(process.env.MEDIUM1_CHANNEL_ID)
            .setLabel("LUXURY")
            .setStyle(ButtonStyle.Primary);

        const statement3 = new ButtonBuilder()
            .setCustomId(process.env.MEDIUM2_CHANNEL_ID)
            .setLabel("CULT")
            .setStyle(ButtonStyle.Success);

        const statement4 = new ButtonBuilder()
            .setCustomId(process.env.HARD_CHANNEL_ID)
            .setLabel("WANTED")
